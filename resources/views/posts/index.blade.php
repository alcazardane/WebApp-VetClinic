            ...
            <div class="list-group-item mb-3" aria-current="true">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <small>
                            <a href="posts-destroy/{{ $post->id }}" class="me-2 text-danger" style="text-decoration: none;">
                            ...
                            <a href="{{ route('posts.show', $post->id) }}" class="me-2 text-primary" style="text-decoration: none;">
                            ...
                            <a href="/posts-publish/{{ $post->id }}" class="me-2 text-success" type="button" style="text-decoration: none;">
                            ...
                            <a href="{{ route('posts.edit', $post->id) }}" class="me-2 text-secondary" type="button" style="text-decoration: none;">
