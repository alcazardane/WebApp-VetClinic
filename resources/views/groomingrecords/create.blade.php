...
@section('layout_content')
    <div class="container-fluid">
        <div class="row justify-content-between mt-4">
            ...
            <div class="display-6">
                Add New Grooming Record
            </div>
        </div>
        
        <div class="row justify-content-between mt-4">
            <form method="POST" action="{{ route('groomingrecords.store') }}">
                @csrf
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="species" id="_species" placeholder="Species" class="form-control">
                            </div>
                            <div class="col">
                                <label for="_breed" class="form-label">Breed</label>
                                <input type="text" name="breed" id="_breed" placeholder="Breed" class="form-control">
                            </div>
                        </div>
                    </div>
