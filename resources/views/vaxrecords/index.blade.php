        ...
        <table class="table table-sm" style="background-color: #fff;">
            ...
            @foreach ($vaxrecords as $vaxrecords)
                <tr>
                    ...
                    <td>
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal{{ $vaxrecords->id }}" class="btn" type="button" style="color: #990000;">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        If you delete this record, the vaccine history of this record will also be deleted forever.<br>Do you wish to proceed?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                        <a href="{{ route('vaxrecords.destroy', $vaxrecords->id) }}" type="button" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <td>
                        <a href="{{ route('vaxrecords.show', $vaxrecords->id) }}" class="me-2 ms-1" type="button" style="color: #1B4F72; text-decoration: none;">
                    ...
                    <td>
                        <a href="{{ route('vaxrecords.edit', $vaxrecords->id) }}" class="me-2 ms-1" type="button" style="color: #aaaaaa; text-decoration: none;">
