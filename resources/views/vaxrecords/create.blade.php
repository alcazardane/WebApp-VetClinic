...
@section('layout_content')
    <div class="container-fluid">
        <div class="row justify-content-between mt-4">
            ...
            <div class="display-6">
                Set New Vaccine Record
            </div>
        </div>

        <div class="row justify-content-between mt-4">
            <form method="POST" action="{{ route('vaxrecords.store') }}">
                @csrf
                    ...
                    <div class="mb-3 ">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="owneremail" id="_owneremail" placeholder="Owner Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="species" class="form-control" id="_species" placeholder="Species">
                            </div>
                            <div class="col">
                                <label for="_breed" class="form-label">Breed</label>
                                <input type="text" class="form-control" name="breed" id="_breed" placeholder="Breed">
                            </div>
                        </div>              
                    </div>
