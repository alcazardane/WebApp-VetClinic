...
@section('_routes')
    ...
    @if (Auth::user()->user_type == 'admin')
        <a href="{{ route('vetstaff.index') }}" class="list-group-item list-group-item-action py-2 ripple mt-3" aria-current="true" style="color: #58753C; font-weight: bold;">
    ...
    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'vet')
        <a class="list-group-item list-group-item-action py-2 ripple mt-3 dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="cursor: pointer; color: #a8a8a8;">
        ...
        <table class="table" style="background-color: #fff;">
            ...
            @foreach ($vetstaff as $vetstaff)
                <tr>
                    ...
                    <td>{{$vetstaff->desc}}</td>
                    <td>
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal{{ $vetstaff->id }}" class="btn" type="button" style="color: #990000;">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    If you delete this record, it will deleted forever.<br> Do you wish to proceed?
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <a href="{{ route('vetstaff.destroy', $vetstaff->id) }}" type="button" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <td>
                        <a href="{{ route('vetstaff.show', $vetstaff->id) }}" class="btn" type="button" style="color: #1B4F72">
                    ...
                    <td>
                        <a href="{{ route('vetstaff.edit', $vetstaff->id) }}" class="btn" type="button" style="color: #aaaaaa">
