...
@section('layout_content')
    <div class="container-fluid">
        <div class="row justify-content-between mt-4">
            ...
            <div class="display-6">
                Edit Surgical Record
            </div>
        </div>

        <div class="row justify-content-between mt-4">
            <form action="{{ route('surgicalrecords.update', $records->id) }}" method="post">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="gender" id="_gender">
                                    <option @if($records->gender == 'Male') selected @endif value="Male">Male</option>
                                    <option @if($records->gender == 'Female') selected @endif value="Female">Female</option> 
                                </select>
                            </div>
                        </div>
                    </div>
