...
@section('layout_content')
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <p class="display-6">Consultation History</p>
        </div>
        ...
        <div class="row mt-4">
            ...
            <div class="btn-group-sm mt-3" role="group" aria-label="Basic example">
                ...
                @if (count($history) > 0)
                    <a href="{{ route('consultationhistorydoc.store', $records->id) }}" class="btn btn-secondary btn-sm">
                ...
                <div class="table-responsive">
                    <table class="table bg-light">
                        <tr class="bg-success text-white">
                            ...
                            <td class="h6" scope="col">Temp</td>
                            <td class="h6" scope="col">Vet</td>
                        ...
                        @if (count($history) >= 1)
                            @foreach ($history as $history)
                                <tr>
                                    ...
                                    <td>{{ $history->vet }}</td>
                                    <td>
                                        <a href="{{ route('consultationhistory.destroy', $history->id) }}" class="btn" type="button" style="color: #990000;">
                                ...
                                <tr>
                                    <td class="collapse multi-collapse" id="multiCollapseEdit{{ $history->id }}" colspan="5">
                                        <table class="table mb-0">
                                            <div>
                                                @include('inc.editconsultationhistory')
                                            </div>
        ...
        <div class="row mt-4">
            <div class="collapse multi-collapse" id="multiCollapseExample1">
                @include('inc.createconsultationhistory')
            </div>
        </div>
    </div>
@endsection