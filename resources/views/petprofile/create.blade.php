...
<div class="container-fluid p-5">
    ...
    <div class="row justify-content-between mt-4">
        <form method="POST" action="{{ route('petprofile.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="mb-3 ">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="petname" id="_petname" placeholder="Pet Name" required>
                        </div>
                        <div class="col">
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="petspecies" id="_petspecies" placeholder="Species" class="form-control" required>
                        </div>
                        <div class="col">
                            <label for="_petbreed" class="form-label">Pet Breed</label>
                            <input type="text" name="petbreed" id="_petbreed" placeholder="Breed" class="form-control" required>
                        </div>
                    </div>
                </div>
