...
@section('_routes')
    ...
    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'staff' || Auth::user()->user_type == 'vet')
        ...
        <a href="{{ route('publicposts.index') }}" class="list-group-item list-group-item-action py-2 ripple mt-3" aria-current="true" style="color: #58753C; font-weight: bold;">
            ...
            <div class="list-group-item mb-3" aria-current="true">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <small>
                            <a href="/publicposts-hidepost/{{ $pub->id }}" class="me-2" style="color: #58753C; text-decoration: none;">
                            ...
                            <a href="{{ route('publicposts.show', $pub->id) }}" class="me-2" style="color: #1B4F72; text-decoration: none;">
                            ...
                            <a href="/publicposts-destroy/{{ $pub->id }}" class="me-2" style="color: #990000; text-decoration: none;">
