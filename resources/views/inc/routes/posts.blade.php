@section('_routes')
    ...
    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'staff' || Auth::user()->user_type == 'vet')
        ...
        <a href="{{ route('posts.index') }}" class="list-group-item list-group-item-action py-2 ripple mt-3" aria-current="true" style="color: #58753C; font-weight: bold;" active>
    ...
    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'vet')
        ...
        <a href="{{ route('archive.index') }}" class="list-group-item list-group-item-action py-2 ripple mt-3" aria-current="true" style="color: #a8a8a8;">
