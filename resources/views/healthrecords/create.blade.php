                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="date" name="birthday" class="form-control" id="_birthday" placeholder="Birthday">
                            </div>
                        </div>              
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="contactnum" class="form-control" id="_contactnum" placeholder="Contact Number">
                            </div>
