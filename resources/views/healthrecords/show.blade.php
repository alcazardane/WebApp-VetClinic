...
@section('layout_content')
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <p class="display-6">Medical History</p>
        </div>
        ...
        <div class="row mt-4">
            ...
            <div class="btn-group-sm mt-3" role="group" aria-label="Basic example">
                ...
                @if (count($history) > 0)
                    <a href="/docxgenerate/{{ $healthrecords->id }}" class="btn btn-secondary btn-sm">
                ...
                <div class="table-responsive">
                    <table class="table bg-light">
                        <tr class="bg-success text-white">
                            ...
                            <td class="h6" scope="col">Temperature</td>
                            <td class="h6" scope="col">Diagnosis</td>
                            <td class="h6" scope="col">Treatment</td>
                            <td class="h6" scope="col">VX/MX</td>
                        ...
                        @if (count($history) >= 1)
                            @foreach ($history as $history)
                                <tr>
                                    ...
                                    <td>{{ $history->temp }}</td>
                                    <td>{{ $history->checkup }}</td>
                                    <td>{{ $history->Treatment }}</td>
                                    <td>{{ $history->vxmx }}</td>
                                    <td>
                                        <a href="/healthrecords/medicalhistory-destroy/{{$history->id}}" class="btn" type="button" style="color: #990000;">
