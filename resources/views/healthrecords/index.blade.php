...
<!--Sidebar-->
@include('inc.routes.healthrecords')
    ...
    <div class="table-responsive mt-4">
        <table class="table" style="background-color: #fff;">
            ...
            @foreach ($healthrecords as $healthrecords)
                @if ($healthrecords->status == "active")
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('healthrecords.show', $healthrecords->id) }}" class="btn" type="button" style="color: #0d6efd;">
                        ...
                        <td>
                            <button data-bs-toggle="modal" data-bs-target="#exampleModal{{ $healthrecords->id }}" class="btn" type="button" style="color: #adb5bd;">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('healthrecords.archive', $healthrecords->id) }}" type="button" class="btn btn-success">Yes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td>
                            <a href="{{ route('healthrecords.edit', $healthrecords->id) }}" class="btn" type="button" style="color: #198754">
