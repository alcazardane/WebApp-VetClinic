...
<div class="row">
    <div class="col mt-3">
        <form action="{{ route('healthrecords.index') }}" method="GET" role="search" class="d-flex">
            ...
            <a href="{{ route('healthrecords.index') }}" class="btn btn-secondary me-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2v1z"/>
                    <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z"/>
                </svg>
            </a>
            <a href="{{ route('healthrecords.create') }}" type="button" class="btn btn-success">+</a>
        </form>
    </div>
</div>
@endsection
...
@section('_routes')
    ...
    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'vet')
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li>
                <a href="{{ route('healthrecords.index') }}" class="dropdown-item" style="color: #58753C; font-weight: bold;">Health Records</a>
            </li>
            <li>
...
@section('tbl_name')
    <p class="display-6">Health Records</p>
@endsection
        ...
        <table class="table" style="background-color: #fff;">
            ...
            @foreach ($healthrecords as $healthrecords)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('healthrecords.show', $healthrecords->id) }}" class="btn" type="button" style="color: #1B4F72;">
                    ...
                    <td>
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal{{ $healthrecords->id }}" class="btn" type="button" style="color: #990000;">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        If you delete this record, the medical history of this record will also be deleted forever.
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                        <a href="{{ route('healthrecords.destroy', $healthrecords->id) }}" type="button" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <td>
                        <a href="{{ route('healthrecords.edit', $healthrecords->id) }}" class="btn" type="button" style="color: #aaaaaa">
